...
pub fn get_minecraft_launchers_instances_folders(drive: &str, username: &str) -> Vec<(String, String)> {
    ...
    database.push((String::from(drive.to_owned() + "Users\\" + username + "\\AppData\\Roaming\\MultiMC\\instances\\**\\minecraft"), String::from("MultiMC")));
    database.push((String::from(drive.to_owned() + "Users\\" + username + "\\AppData\\Roaming\\PrismLauncher\\instances\\**\\minecraft"), String::from("PrismLauncher")));
    database.push((String::from(drive.to_owned() + "Users\\" + username + "\\AppData\\Roaming\\PrismLauncher\\instances\\**\\.minecraft"), String::from("PrismLauncher")));
    database.push((String::from(drive.to_owned() + "Users\\" + username + "\\AppData\\Roaming\\PolyMC\\instances\\**\\minecraft"), String::from("PolyMC")));
    database.push((String::from(drive.to_owned() + "Users\\" + username + "\\AppData\\Roaming\\PolyMC\\instances\\**\\.minecraft"), String::from("PolyMC")));
    database.push((String::from(drive.to_owned() + "Users\\" + username + "\\AppData\\Roaming\\ATLauncher\\instances\\**"), String::from("ATLauncher")));
    database.push((String::from(drive.to_owned() + ".loliland\\updates\\clients\\**"), String::from("LoliLand")));
    database.push((String::from(drive.to_owned() + "Users\\" + username + "\\.cristalix\\updates\\**"), String::from("Cristalix")));
...
pub fn get_minecraft_launchers_folders(drive: &str, username: &str) -> Vec<(String, String)> {
    ...
    database.push((String::from(drive.to_owned() + "Users\\" + username + "\\AppData\\Roaming\\PrismLauncher"), String::from("PrismLauncher")));
    database.push((String::from(drive.to_owned() + "Users\\" + username + "\\AppData\\Roaming\\PolyMC"), String::from("PolyMC")));
    database.push((String::from(drive.to_owned() + "Users\\" + username + "\\AppData\\Roaming\\ATLauncher"), String::from("ATLauncher")));
    database.push((String::from(drive.to_owned() + "Users\\" + username + "\\AppData\\Roaming\\.gribland\\bin"), String::from("GribLand")));
    database.push((String::from(drive.to_owned() + "Users\\" + username + "\\AppData\\Roaming\\.gribland"), String::from("GribLand")));
    database.push((String::from(drive.to_owned() + "Users\\" + username + "\\curseforge\\minecraft\\Install"), String::from("CurseForge")));
